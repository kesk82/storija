                            ...
                            <div class="post-item">
                                <div class="post-item-wrap">
                                    ...
                                    <div class="post-item-description">
                                        <h1><?php the_title() ?></h1>
                                        <div class="post-meta">
                                            <span class="post-meta-date"><i class="fa fa-calendar-o"></i><?php storija_posted_on(); ?></span>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		the_content(
			sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'storija' ),
					array(
						'span' => array(
							'class' => array(),
						),
		...
		wp_link_pages(
			array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'storija' ),
				'after'  => '</div>',
			)
		);
		?>
